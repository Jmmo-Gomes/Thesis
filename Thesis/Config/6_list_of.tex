...
\ntaddlistof{tableofcontents}    % The Table of Contents
\ntaddlistof{listoffigures}      % The List of Figures
\ntaddlistof{listoftables}       % The List of Tables
\ntaddlistof{listofalgorithms}   % The List of Algorithms
\ntaddlistof{listoflistings}     % The List of Listings
\ntaddlistof{listsofglossaries}  % The Glossary
