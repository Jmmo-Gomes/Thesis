...
\ntsetup{docdegree=mscplan}     % The type of document
%                               %     [     phd —> PhD thesis
...
\ntsetup{langsused={en,pt}}     % List of languages are used in the document
...
% \ntsetup{printindex=true}     % Print the (words) index at the end of the document
%                               % DEFAULT: printindex=false
...
% \ntsetup{webography=Webography} % Generate a separate bibliography for @online references
...
%                               %       fmv, hansen, ist, pedersen, vz34, vz43 ]
