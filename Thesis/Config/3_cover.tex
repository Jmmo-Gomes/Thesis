...
%-------------------------------------------------------------------
\ntauthorname(m){João Manuel Morais Gomes}{João Gomes}
...
\ntauthordegree(en){Master in Computer Science}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Miguel Carlos Pacheco Afonso Goulão, Associate Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){Vasco Miguel Moreira Amaral, Associate Professor, NOVA University Lisbon}
